...
//   return (
//     <section className="glass-about-us my-10 py-20 max-w-4xl mx-auto px-4" id="ourStory">
...
<p className="text-xs uppercase tracking-widest text-gray-400 text-center mb-3 ">
  {t.label}
      ...
      <h2 className="font-bold text-center mb-10 text-2xl md:text-3xl">
        {t.title}
      </h2>
 ...
 */}
  ...
  <div className="mt-12 pt-6 border-t border-gray-200">
    <p className="text-center font-medium text-gray-900 text-sm sm:text-base md:text-lg">
