    ...
    <section ref={ref} id="contact" className={`bg-[#1e293b] py-20 contact-radius mx-2 glass-section fade-up ${isVisible ? "fade-up-visible" : ""} `}>
      ...
      lg:text-xl ">
          ...
          <div className="flex justify-center items-center gap-3 mb-3">
            ...
            <a href="mailto:contact@brightway2deutschland.com" className="hover:text-blue-400 text-sm
      sm:text-base
      md:text-lg
      lg:text-xl transition">
          ...
          <div className="flex justify-center items-center gap-3 mb-6 ">
            ...
            <a href="tel:+49 4141 428 438" className="hover:text-blue-400 text-sm
      sm:text-base
      md:text-lg
      lg:text-xl transition">
              +49 4141 428 438
